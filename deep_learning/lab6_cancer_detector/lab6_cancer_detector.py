...
l5 = max_pool(l4, name = 'pool5')
l6 = conv(l5, name = 'conv6', num_filters = 256)
l7 = conv(l6, name = 'conv7', num_filters = 256)
l8 = upconv(l7, name = 'upconv8', output_channels = 128)
l9 = tf.concat([l4, l8], 3, name = 'concat9')
l10 = conv(l9, name = 'conv10', num_filters = 128)
l11 = conv(l10, name = 'conv11', num_filters = 128)
l12 = upconv(l11, name = 'upconv12', output_channels = 64)
